...
--
-- Host: localhost
-- Generation Time: Oct 28, 2009 at 07:56 PM
...
--
-- Table structure for table `events_raw_events`
--

CREATE TABLE IF NOT EXISTS `events_raw_events` (
  `event_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `source_id` int(10) unsigned NOT NULL,
  `event_time_added_at` datetime NOT NULL,
  `event_title` varchar(255) NOT NULL,
  ...
  `event_link` text NOT NULL,
  `event_tags` varchar(255) NOT NULL,
  `event_raw_data` text NOT NULL,
  PRIMARY KEY (`event_id`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;

--
-- Dumping data for table `events_raw_events`
--
